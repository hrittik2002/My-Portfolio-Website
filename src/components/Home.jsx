...
import HeroImage from '../assets/me2.jpeg'
            ...
            <div className="max-w-screen-lg mx-auto flex flex-col items-center justify-center h-full px-4 md:flex-row">
                <div className="flex flex-col justify-center h-full">
                    ...
                    <p className="text-gray-500 py-4 max-w-md">
                        Lorem ipsum dolor sit amet consectetur adipisicing elit. Hic corporis vitae quidem obcaecati ea esse non reprehenderit recusandae saepe alias, quo excepturi omnis quis?
                    </p>
                    <div>
